...
const categories = [
  {
    ...
    desc: { en: "GLP-1 medications — compounded, oral, or branded", es: "Medicamentos GLP-1, planes personalizados" },
  ...
  },
  {
    ...
    desc: { en: "Hair restoration, anti-aging & brightening formulas", es: "Restauración capilar y cuidado de piel grado médico" },
  ...
  },
  {
    ...
    desc: { en: "Anxiety, sleep, mood & motivation — non-addictive meds", es: "Ansiedad, sueño y estado de ánimo — sin medicamentos adictivos" },
  ...
  },
  {
    ...
    desc: { en: "Get a personalized recommendation in 2 minutes", es: "Obtén una recomendación personalizada en 2 min" },
